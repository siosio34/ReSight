...
public class HandMotionSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDataset.add(new HandMotion("동작 : 손 펴기", R.drawable.icon_hand00_open,"0"));
        myDataset.add(new HandMotion("동작 : 주먹쥐기", R.drawable.icon_hand01_closed,"1"));
        myDataset.add(new HandMotion("동작 : 손가락 접기", R.drawable.icon_hand02_finger_closed,"2"));
        myDataset.add(new HandMotion("동작 : 손 오므르기", R.drawable.icon_hand03,"3"));
        myDataset.add(new HandMotion("동작 : 새끼손가락 펴기", R.drawable.icon_hand04,"4"));
        myDataset.add(new HandMotion("동작 : 브이하기", R.drawable.icon_hand08,"5"));
