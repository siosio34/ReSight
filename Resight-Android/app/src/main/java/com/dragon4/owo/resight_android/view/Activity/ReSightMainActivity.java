...
public class ReSightMainActivity extends AppCompatActivity implements BottomNavigationBar.OnTabSelectedListener {
   ...
   //    View testFragmentView = monitoringFragment.getView();
   //    Log.d("ddddddd","ddddd");
   //    if(testFragmentView != null) {
   //  //      monitoringFragment.getView().findViewById(R.id.icon_test_hand)
   //        testFragmentView.findViewById(R.id.icon_test_hand).setOnClickListener(new View.OnClickListener() {
   //            @Override
   //            public void onClick(View v) {
   //                Log.d("ddddddd","ddddd");
   //                if(flag) {
